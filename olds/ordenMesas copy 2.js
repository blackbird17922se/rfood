        ...
        $.post(MESA_CTRLR,{consulta,funcion},(response)=>{
            ...
            mesaS.forEach(mesa=>{
                ...
                /* Intr ped */
                    ...
                    $.post(PEDIDOS_CTRL,{funcion, idMesa},(response)=>{
                        console.log('pedidos ctrl retorna: ' + response);
                        ...
                        PEDIDOS.forEach(pedido=>{
                            ...
                            pedido.prods.forEach(item=>{
                                console.log('pedido.prods.forEach: ' + item[2] + ' ' + item[0]);
                            ...
                            // console.log(tempItemsOrden);
                            templateOrden+=`
                                <div class="row">
                                    <div class="col-12">
                                        <h2 class="lead"><b>${tempItemsOrden}</b></h2>
                                    </div>                           
                                </div>
                            `;   
                        });
                        // $('.xr').html(templateOrden);
                    });
                ...
                //console.log('templateOrden. '+templateOrden);
