$(document).ready(function(){
    ...
    /* CARRITO DE COMPRAS AL HACER CLICK EN EL BOTON DE CADA PRODUCTO "AGREGAR AL CARRITO"*/
        ...
        if(id_prod === PRODUCTO.id_prod){
            ...
            recuperarLS_car_compra();
            contarProductos();
            // $('#lista-compra').load('carrito.js');
            // recuperarLS()
            // recuperarLS_car();
            // $('#lista-compra').html(PRODUCTO);
...
//   $.get("#lista-compra","",function(respuesta){
//     console.log(respuesta);
//     $('#lista-compra').html(respuesta);
//   });
// }
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            ...
                            $.post('../controllers/compraController.php',{funcion},(response)=>{
                                ...
                                // $.post('../controllers/PDFController.php',{id},(response2)=>{
