$(document).ready(function(){
    ...
    function listarPedidos(){
        ...
        $.post('../controllers/pedidoController.php',{funcion},(response)=>{
            ...
            PEDIDOS.forEach(ped=>{
                template+=`
                <div usuId="${ped.id_det_pedido}" class="col-12 col-sm-6 col-md-4 align-items-stretch">

                    <div class="card bg-light">
                        <div class="card-header text-muted border-bottom-0">Orden: ${ped.id_det_pedido}</div>
