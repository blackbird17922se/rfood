                ...
                <div class="card-body">
                    ...
                    <form action="" id="form-crear-product">
                        ...
                        <div class="form-group">
                            <label for="xpy">XPy producto</label>
                            <select name="xpy" id="xpy" class="form-control select2" style="width: 100%;"></select>
                        </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
                     <!-- XP LISTA -->
                     <div class="form-group">
                            <label for="xp">XP producto</label>
                            <select name="xp" id="xp" class="form-control select2" style="width: 100%;"></select>
                        </div>
